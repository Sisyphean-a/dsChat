...
| 模型、协议和能力 | [ds-chat](packages/ds-chat.md)、[ADR-0001](../requirements/adrs/0001-provider-protocol-and-tool-boundaries.md) | `src/constants/providerProfiles.ts`、`src/services/ai/providerAdapter.ts` |
