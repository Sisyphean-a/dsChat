...
| 流式回复与工具 | [ds-chat](packages/ds-chat.md)、[ADR-0001](../requirements/adrs/0001-provider-protocol-and-tool-boundaries.md) | `src/composables/chatAppReplyLifecycle.ts`、`src/services/ai/toolOrchestrator.ts`、`src/services/tools/` |
