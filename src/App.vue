...
<template>
  <div class="app-shell">
    ...
    <main class="chat-stage">
      ...
      <div class="composer-container">
        <ChatComposer
          ...
          :thinking-level="app.thinkingLevel.value"
          :thinking-options="app.thinkingOptions.value"
          :send-disabled="app.isSending.value"
          @add-images="app.addPendingImages"
          @remove-attachment="app.removePendingAttachment"
          @update-thinking-level="app.updateActiveThinkingLevel"
    ...
    <SettingsPanel
      ...
      @update-builtin-tool-qwen-image-api-key="app.updateBuiltinToolQwenImageApiKey"
      @update-builtin-tool-qwen-image-base-url="app.updateBuiltinToolQwenImageBaseUrl"
      @update-builtin-tool-qwen-image-model="app.updateBuiltinToolQwenImageModel"
      @update-custom-model-capability="app.updateCustomModelCapability"
